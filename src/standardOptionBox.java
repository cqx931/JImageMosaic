...
getContentPane().add(jPanel1, new extras.AbsoluteConstraints(10, 10, 500, 110));
...
getContentPane().add(jButton1, new extras.AbsoluteConstraints(440, 240, 70, -1));
...
getContentPane().add(jButton2, new extras.AbsoluteConstraints(360, 240, -1, -1));

jButton3.setText("Algorithm Options");
buttonGroup1.add(jButton3);
getContentPane().add(jButton3, new extras.AbsoluteConstraints(360, 210, -1, -1));
...
getContentPane().add(colorCorrectSelect, new extras.AbsoluteConstraints(10, 250, -1, -1));

colorCorrectField.setText("50");
getContentPane().add(colorCorrectField, new extras.AbsoluteConstraints(180, 250, 40, -1));
...
getContentPane().add(jPanel2, new extras.AbsoluteConstraints(10, 130, 500, 70));
