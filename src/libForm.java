...
getContentPane().add(evaluationProgressBar, new extras.AbsoluteConstraints(20, 640, 550, 20));

algorithmBox.setEnabled(false);
getContentPane().add(algorithmBox, new extras.AbsoluteConstraints(160, 610, 230, -1));
...
getContentPane().add(pauseButton, new extras.AbsoluteConstraints(570, 640, 80, 20));
...
getContentPane().add(jPanel1, new extras.AbsoluteConstraints(10, 10, 720, 590));
...
getContentPane().add(cancelButton, new extras.AbsoluteConstraints(650, 640, 80, 20));

jLabel1.setText("Evaluation Algorithm:");
getContentPane().add(jLabel1, new extras.AbsoluteConstraints(20, 610, 140, -1));

algOptionsButton.setText("Options");
algOptionsButton.setEnabled(false);
getContentPane().add(algOptionsButton, new extras.AbsoluteConstraints(400, 610, -1, -1));
